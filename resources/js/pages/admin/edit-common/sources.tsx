...
export default function Sources({
    ...
    const { data, setData, post, patch, errors, processing } = useForm({
        sources_ids: model ? model.data.sources?.map((source) => source.id) : [] as number[],
    });
    ...
    const submit: FormEventHandler = (e) => {
        ...
        post(route(type + '.update.sources', model.data), {
            preserveScroll: true,
            preserveState: false,
        });
    };
                ...
                <div className="mx-auto lg:px-8">
                    <div className="">
                        <form onSubmit={submit} className="space-y-3 bg-inherit">
                            <Tabs model={model} type={type} processing={processing} />
                            <div>
                                <Select
